...
elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL "arm")
    # Keep old behavior for unknown ARM toolchains.
    set(AX_TTS_THIRDPARTY_FLAVOR "arm_uclibc")
else()
...
if(NOT EXISTS ${ESPEAK_LIB_DIR})
    message(FATAL_ERROR "espeak lib dir not found: ${ESPEAK_LIB_DIR}")
endif()
